...
typedef struct
{
   ...
   unsigned int num_dg_rows;    /**< index of first row included in storage region dark current sum [rows numbered 1..N] */
   unsigned int num_tg_rows;    /**< number of rows included in storage region dark current sum */
