...
def create_config_file_text (work_dir, radiance_dir, goes_west_dir, goes_east_dir, terrain_reg):
    """
...
def initialize_working_directory (work_dir, rad_paths, goes_west_paths, goes_east_paths, terrain_reg):
    ...
    # populate subdirectories with GOES East/West imagery
    goes_west_dir = os.path.join (work_dir, "goes_west")
    os.mkdir (goes_west_dir)
    make_symlinks (goes_west_dir, goes_west_paths)
    goes_east_dir = os.path.join (work_dir, "goes_east")
    os.mkdir (goes_east_dir)
    make_symlinks (goes_east_dir, goes_east_paths)
    ...
    config_file_text = create_config_file_text (work_dir, radiance_dir, goes_west_dir, goes_east_dir, terrain_reg)
...
def main():
    ...
    parser.add_argument('--terrain_reg', default='T', help="Radiance geolocation is terrain registered [T|F]")
    ...
    initialize_working_directory (work_dir, rad_paths, goes_west_paths, goes_east_paths, args.terrain_reg)
