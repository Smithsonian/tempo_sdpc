...
def apply_background (control, corrfile, input_files):
...
def main():
    ...
    if pipe_dir is None:
        ...
        default_config = os.path.join (pipe_dir, "etc/background.yml")

    parser = argparse.ArgumentParser(description='Background L2 products')
    ...
    apply_background (control, args.corrfile, args.filenames)
