...
stage_dir="$SDPC_PIPE_DIR/stage/granules/inr_output/nrt/pass1"
...
o2o2_dir="$SDPC_PIPE_DIR/stage/granules/inr_output/nrt/o2o2"
if ! test -d $o2o2_dir ; then
   mkdir -p $o2o2_dir
fi
...
jid=$(sbatch -vvv --job-name="nL1b" --parsable --partition="$SDPC_NRT_PARTITION" \
...
echo "level1b_nrt1_batch.sh ${rad_basename}.nc $file_list_file"
