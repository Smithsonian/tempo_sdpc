...
#
lev2_file_fmt=$(mkgranule_name -L 2 -p %s -v $processing_version ${rad_basename}.nc)
...
sed \
 ...
 -e s,@solcal_source@,$solcal_source,g \
 ...
 -e s,@versionid@,$processing_version,g \
...
case "$rad_basename" in
   *_NRT_* )
     arch_dest="NRT/L2"
     fix_nrt_shortname.py $product_file
     ;;
   * )
     arch_dest="L2"
     ;;
...
# Compute md5 checksum while product file is cached in RAM
# even though it may get updated later.
