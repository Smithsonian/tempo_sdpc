...
CONTAINS
  ...
  FUNCTION L1Br_open(this, fn, swn, nL) RESULT (status)
    ...
    !write (6,*) "L1Br_open: file=", fn, "reclen =", reclen, " swn=", swn
  ...
  !
  !!
!UNUSED!   FUNCTION L1Br_getDIMsize(this, dimname) RESULT(size)
!UNUSED!     !INCLUDE 'PGS_OMI_1900.f'  !defines the L1B PGS error codes
!UNUSED!     USE OMSAO_errstat_module
!UNUSED!     TYPE (L1B_block_type), INTENT(INOUT) :: this
!UNUSED!     CHARACTER (LEN = *), INTENT(IN) :: dimname
!UNUSED!     INTEGER (KIND = 4) :: size
!UNUSED!     CHARACTER (LEN = MAX_NAME_LENGTH) :: msg
!UNUSED! 
!UNUSED!     IF(.NOT. this%initialized) THEN
!UNUSED!       ierr = OMI_SMF_setmsg(OMI_E_INPUT, &
!UNUSED!         "input block not initialized", &
!UNUSED!         "L1Br_getDIMsize", zero)
!UNUSED!       size = -1
!UNUSED!       RETURN
!UNUSED!     ENDIF
!UNUSED! 
!UNUSED!     SELECT CASE(dimname)
!UNUSED!     CASE("NumTimes")
!UNUSED!       size = this%NumTimes
!UNUSED!       RETURN
!UNUSED!     CASE("nXtrack")
!UNUSED!       size = this%nXtrack
!UNUSED!       RETURN
!UNUSED!     CASE("nWavel")
!UNUSED!       size = this%nWavel
!UNUSED!       RETURN
!UNUSED!     CASE("nWavelCoef")
!UNUSED!       size = this%nWavelCoef
!UNUSED!       RETURN
!UNUSED!     CASE("NumTimesSmallPixel")
!UNUSED!       size = this%NumTimesSmallPixel
!UNUSED!       RETURN
!UNUSED!     CASE DEFAULT
!UNUSED!       msg = "unknown dimension name: " // dimname
!UNUSED!       ierr = OMI_SMF_setmsg(OMI_E_INPUT, msg, "L1Br_getDIMsize", zero)
!UNUSED!       size = -1
!UNUSED!       RETURN
!UNUSED!     END SELECT
!UNUSED!   END FUNCTION L1Br_getDIMsize
  ...
  FUNCTION L1Br_getGEOline(this, iLine, Time_k, SecondsInDay_k, &
    ...
    USE OMSAO_omidata_module, ONLY: szoom_mode
