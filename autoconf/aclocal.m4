...
HDFEOS_LIB="\$(OTS_ROOT)/hdfeos/lib/$OMIUTIL_SYSDIR"
HDFEOS_INC="\$(OTS_ROOT)/hdfeos/include"
HDFEOS5_LIB="\$(OTS_ROOT)/hdfeos5/lib/$OMIUTIL_SYSDIR"
HDFEOS5_INC="\$(OTS_ROOT)/hdfeos5/include"
dnl #
AC_SUBST(HDFLIB)
AC_SUBST(HDFINC)
AC_SUBST(HDFEOS_LIB)
