MODULE OMSAO_he5_module
  ...
  USE OMSAO_parameters_module, ONLY: maxchlen, i2_missval, i4_missval, &
       r4_missval, r8_missval, blank13, valid_max_i2, valid_max_i4, &
       valid_min_r8, valid_max_r8, zero_r8, one_r8, elsunc_usrstop_eval_r8, &
       elsunc_highest_eval_r8, main_qa_min_flag_r8, main_qa_max_flag_r8
  ...
  ! ------------------------------------------------------------------
  INTEGER (KIND=C_LONG)                :: he5_start_1d, he5_stride_1d, &
       he5_edge_1d
  INTEGER (KIND=C_LONG), DIMENSION (2) :: he5_start_2d, he5_stride_2d, &
       he5_edge_2d
  INTEGER (KIND=C_LONG), DIMENSION (3) :: he5_start_3d, he5_stride_3d, &
       he5_edge_3d
  INTEGER (KIND=C_LONG), DIMENSION (6) :: he5_start_6d, he5_stride_6d, &
       he5_edge_6d
  INTEGER (KIND=C_LONG), DIMENSION (7) :: he5_start_7d, he5_stride_7d, &
       he5_edge_7d
...
!      INTEGER (KIND = C_LONG)   :: swath_id
!      INTEGER (KIND = C_LONG)   :: datatype
!      INTEGER (KIND = C_LONG)   :: rank
!      INTEGER (KIND = C_LONG), DIMENSION(MAXRANK) :: dims
  END TYPE DFHE5_T

   INTEGER (KIND=4), PARAMETER :: NDIM_MAX    = 22
   INTEGER (KIND=4), PARAMETER :: NFLDS_MAX   = 100
...
!      INTEGER (KIND = i4), DIMENSION(0:NFLDS_MAX) :: accuLineSize, accuBlkSize
      ...
      INTEGER (KIND = C_LONG), DIMENSION(0:NFLDS_MAX) :: accuLineSize, &
           accuBlkSize
      LOGICAL                                     :: initialized
  ...
  INTEGER (KIND = i4), EXTERNAL :: &
       ...
       he5_ehglattinf, HE5_SWinqswath, HE5_SWinqdims, HE5_SWinqgflds, &
       HE5_SWinqdflds, he5_ehinqglatts, he5_swdefchunk, he5_swdefcomp, &
