!
module m_solar_fit_vary

  public solar_fit_vary
  private
...
contains
  ...
  SUBROUTINE solar_fit_vary (slit_unit, error )
    ...
    USE OMSAO_variables_module,  ONLY : curr_sol_spec, n_fitvar_sol, &
         ...
         slit_redo, slit_fname, nsolpix, winlim, poly_order, solslitfit, &
         which_slit, wavcal_sol, fixslitcal, fitweights, fitwavs, currspec, &
         fitvar_sol_saved, numwin, nslit, slitwav, slitfit, sol_spec_ring, &
         nsol_ring, currpixchar, fitvar_sol_init,lo_sunbnd_init, &
    ...
    INTEGER :: npoints, i, iwin, fidx, lidx, errstat = pge_errstat_ok, &
         ...
         linter, npoly, solfit_exval, slidx, sfidx!, nstep, n_fit_pts, j
