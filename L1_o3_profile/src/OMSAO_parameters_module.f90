...
MODULE OMSAO_parameters_module
  ...
  INTEGER, PARAMETER :: max_fit_pts  = 1100   ! fitted array 2024
  ...
  !
  ! NOTE that the values for R4_MISSVAL and R8_MISSVAL are identical. This is
  ...
  REAL (KIND=r8), PARAMETER :: &
       valid_min_r8 = -9.9E+99_r8, valid_max_r8 = +9.9E+99_r8, &
       zero_r8 = 0.0_r8, one_r8 = 1.0_r8, &
       valid_max_i2 = REAL(HUGE(1_i2), KIND=r8), &
       valid_max_i4 = REAL(HUGE(1_i4), KIND=r8)
