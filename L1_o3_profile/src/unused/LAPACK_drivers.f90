!> LU decomposition and linear equation solving for reals
module LAPACK_drivers
  use LAPACK_BLAS_tools, only: daxpy, dcopy, dgemm, dgemv, dger, dscal, &
       dswap, dtbsv, dtrsm, ddot, idamax
  use LAPACK_tools, only: dgbtf2, dgetf2, dlassq, dlaswp, dlatbs, dlatrs, &
       drscl, lsame, ilaenv
  use LAPACK_dlamch, only: dlamch
  use LAPACK_ev, only: dlacn2
  use m_xerbla

  public dgbtrf, dgbtrs, dgetrf, dgetrs, dlange
  private dlangb, dgecon, dgbcon
