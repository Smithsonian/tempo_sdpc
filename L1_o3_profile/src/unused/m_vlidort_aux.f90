...
! #      vlidort_status:        R.J.D. Spurr, RTS, 2005         #
! #      vlidort_lapack_error:  R.J.D. Spurr, CFA, 2004         #
! #      vlidort_error_trace:   R.J.D. Spurr, CFA, 2004         #
...
!  --------------------
      ...
      ELSE IF ( STATUS_INPUTCHECK. EQ. VLIDORT_SERIOUS ) THEN
        ...
        WRITE(*,*)'  ------ Check the Logfile for details'
      ELSE
!        WRITE(*,*)' SUCCESS with VLIDORT input check'
      ENDIF
      ...
      IF ( STATUS_INPUTCHECK. NE. VLIDORT_SERIOUS ) THEN
       IF ( STATUS_CALCULATION. NE. VLIDORT_SUCCESS ) THEN
        ...
        WRITE(*,*)'  ------ Check the Logfile for details'
       ELSE
!        WRITE(*,*)' SUCCESS with VLIDORT execution'
       ENDIF
      ENDIF
...
!  Finish
      ...
      RETURN
      END SUBROUTINE VLIDORT_LAPACK_ERROR
...
!  include file of control variables
...
!  turn off error initialization flag
...
!  finish
      ...
      RETURN
      END SUBROUTINE VLIDORT_ERROR_TRACE
...
!---4/18/08. Use 1.0d-12 (1.0d-24 has convergence issues in Rayleigh layers)
!      TOL = 0.0000001
      TOL = 1.0D-12
!      TOL = 1.0D-24
!      TOL = 1.0D-20
