...
!  (1,1) Function (scalar form)
      ...
      DPHI = SNGL(XPHI)
      DUMMY = ZERO
      HAPKE_VKERNEL(1) = HAPKEKER( DUMMY, DUMMY, MU, MUP, DPHI )
...
!  Quadrature output for first order R/T calculations 
     ...
     I         XJ, SXJ, XM, SXM, PHI_SUB1, CPHI_SUB1, SPHI_SUB1,
     O         R0_QUAD_IN(1,K,N) )
!          write(67,'(2i4,1p16e12.3)')K,N,(R0_OUT_QUAD(M,K,N),M=1,16)
!          write(68,'(2i4,1p16e12.3)')K,N,(R0_QUAD_IN(M,K,N),M=1,16)
        ENDDO
      ENDDO
...
end module m_vlidort_brdf_kernels
