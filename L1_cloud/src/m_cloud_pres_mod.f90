...
module m_cloud_pres_mod
  ...
  integer :: status, NISE 
  real (KIND=8), parameter :: sz_max=86.0d0 ! maximum solar zenith angle
  real (KIND=8) :: sat_zen_max ! max viewing zenith angle, will be updated
   ! to match maximum in ring effect reference file
