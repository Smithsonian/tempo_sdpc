...
! !ROUTINE: sort
!
! !DESCRIPTION:  finds indices to sort an array in ascending order
!
! !CALLING SEQUENCE:
!
!        arr2 = sortind(arr)
...
!
! !OUTPUT PARAMETERS:
      integer, dimension(size(arr)) :: arr2
!                       arr2 : output of indices to sort vector
!
! !SEE ALSO:  numerical recipes sort routines
!
! !REVISION HISTORY:
!
!  21Oct97   J. Joiner    original code
!
!EOP
!-------------------------------------------------------------------------
