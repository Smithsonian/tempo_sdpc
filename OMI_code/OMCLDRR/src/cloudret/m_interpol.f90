...
enddo
!call pzeitend('interpol')

end function interpold

function interpol3(v, x, u) result (r)
...
!-------------------------------------------------------------------------
      ...
      real (kind = 4), dimension(1)          :: dumu, dumr

      dumu(1) = u
      dumr = interpold3(v, x, dumu)
      r = dumr(1)
end function interpol3


function interpold3(v, x, u) result (r)
