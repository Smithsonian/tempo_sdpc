...
real (KIND=8), parameter :: sz_max=86
real (KIND=8), parameter :: bad_thresh=0.02
real (KIND=8), parameter :: refl_cld_mask=0.4
real (KIND=8), parameter :: cld_mask_press_diff=-0.2
...
real (KIND=8) :: ix1r
real (KIND=8) :: delt_shift=-0.002
real (KIND=8) :: noise=0.005
real (KIND=8) :: noise2=0.10   
real (KIND=8) :: delx=0.00001   
real (KIND=8) :: delc=0.00001   
...
real (KIND=8) :: var_inv_cp=1./0.5**2
real (KIND=8) :: var_inv_chl=1./0.5**2 !1./5.0**2
real (KIND=8) :: var_inv_big=1./1e8**2
real (KIND=8) :: var_inv_small=(1.d0/1e-30)**2 
real (KIND=8) :: var_inv_shift=1./0.05**2
real (KIND=8) :: wave_min = 300.
real (KIND=8) :: cld_frac, cld_frac_oc
real (KIND=8) :: diff_chi_max=0.03
real (KIND=8) :: diff_chi_iter_max=-0.05
real (KIND=8) :: pres_sim=0.6
...
real (KIND=8), parameter :: small_frac=0.001
real (KIND=8), parameter :: ice_lat = 60.
real (KIND=8), parameter :: refl_ice = 0.7
integer :: niters
integer :: counts
...
real (KIND=8) :: refl_land_fg=0.03, refl_oc_fg=0.08
real (KIND=8) :: a
real (KIND=8) :: contrast_thresh=0.002, contrast
real (KIND=8) :: refl_clr_thresh=0.11
real (KIND=8) :: refl_thresh=0.15
real (KIND=8) :: a_thresh=5
real (KIND=8) :: reflec1
integer :: eta_w
