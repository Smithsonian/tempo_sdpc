program ftest1
  ...
  values = real([(j, j=0,num_values-1)], kind=8)
...
subroutine create_group (obj, errstat)
  ...
  call tiof_attlist_append (attlist, errstat, "i4_att", att_i4=[111_4])
  call tiof_attlist_append (attlist, errstat, "i8_att", att_i8=[222_8])
  call tiof_attlist_append (attlist, errstat, "r4_att", att_r4=[111.0_4])
  call tiof_attlist_append (attlist, errstat, "r8_att", att_r8=[222.0_8])
...
subroutine check_create (filename, values, max_dims, dimlens, &
  ...
  call tiof_put_i1 (obj, "sbS", int(values(1),kind=1), errstat)
  call tiof_put_i2 (obj, "ssS", int(values(1),kind=2), errstat)
  call tiof_put_i4 (obj, "siS", int(values(1),kind=4), errstat)
  call tiof_put_i8 (obj, "sjS", int(values(1),kind=8), errstat)
  call tiof_put_ui1 (obj, "ubS", int(values(1),kind=1), errstat)
  call tiof_put_ui2 (obj, "usS", int(values(1),kind=2), errstat)
  call tiof_put_ui4 (obj, "uiS", int(values(1),kind=4), errstat)
  call tiof_put_ui8 (obj, "ujS", int(values(1),kind=8), errstat)
  call tiof_put_r4 (obj, "rfS", real(values(1),kind=4), errstat)
  call tiof_put_r8 (obj, "rdS", real(values(1),kind=8), errstat)
  if (errstat < 0) then
  ...
  call tiof_put2d_i1 (obj, "sbA2", start(2:1:-1), edge(2:1:-1), &
                      int(reshape(values(1:product(edge(1:2))), edge(1:2)),kind=1), errstat)
  call tiof_put3d_i1 (obj, "sbA3", start(3:1:-1), edge(3:1:-1), &
                      int(reshape(values(1:product(edge(1:3))), edge(1:3)),kind=1), errstat)
  ...
  call tiof_put2d_i2 (obj, "ssA2", start(2:1:-1), edge(2:1:-1), &
                      int(reshape(values(1:product(edge(1:2))), edge(1:2)),kind=2), errstat)
  call tiof_put3d_i2 (obj, "ssA3", start(3:1:-1), edge(3:1:-1), &
                      int(reshape(values(1:product(edge(1:3))), edge(1:3)),kind=2), errstat)
  ...
  call tiof_put2d_i4 (obj, "siA2", start(2:1:-1), edge(2:1:-1), &
                      int(reshape(values(1:product(edge(1:2))), edge(1:2)),kind=4), errstat)
  call tiof_put3d_i4 (obj, "siA3", start(3:1:-1), edge(3:1:-1), &
                      int(reshape(values(1:product(edge(1:3))), edge(1:3)),kind=4), errstat)
  ...
  call tiof_put2d_i8 (obj, "sjA2", start(2:1:-1), edge(2:1:-1), &
                      int(reshape(values(1:product(edge(1:2))), edge(1:2)),kind=8), errstat)
  call tiof_put3d_i8 (obj, "sjA3", start(3:1:-1), edge(3:1:-1), &
                      int(reshape(values(1:product(edge(1:3))), edge(1:3)),kind=8), errstat)
  ...
  call tiof_put2d_r4 (obj, "rfA2", start(2:1:-1), edge(2:1:-1), &
                      real(reshape(values(1:product(edge(1:2))), edge(1:2)),kind=4), errstat)
  call tiof_put3d_r4 (obj, "rfA3", start(3:1:-1), edge(3:1:-1), &
                      real(reshape(values(1:product(edge(1:3))), edge(1:3)),kind=4), errstat)
  call tiof_put4d_r4 (obj, "rfA4", start(4:1:-1), edge(4:1:-1), &
                      real(reshape(values(1:product(edge(1:4))), edge(1:4)),kind=4), errstat)
  call tiof_put5d_r4 (obj, "rfA5", start(5:1:-1), edge(5:1:-1), &
                      real(reshape(values(1:product(edge(1:5))), edge(1:5)),kind=4), errstat)
  call tiof_put6d_r4 (obj, "rfA6", start(6:1:-1), edge(6:1:-1), &
                      real(reshape(values(1:product(edge(1:6))), edge(1:6)),kind=4), errstat)
  ...
  call tiof_put2d_r8 (obj, "rdA2", start(2:1:-1), edge(2:1:-1), &
                      real(reshape(values(1:product(edge(1:2))), edge(1:2)),kind=8), errstat)
  call tiof_put3d_r8 (obj, "rdA3", start(3:1:-1), edge(3:1:-1), &
                      real(reshape(values(1:product(edge(1:3))), edge(1:3)),kind=8), errstat)
  call tiof_put4d_r8 (obj, "rdA4", start(4:1:-1), edge(4:1:-1), &
                      real(reshape(values(1:product(edge(1:4))), edge(1:4)),kind=8), errstat)
  call tiof_put5d_r8 (obj, "rdA5", start(5:1:-1), edge(5:1:-1), &
                      real(reshape(values(1:product(edge(1:5))), edge(1:5)),kind=8), errstat)
  call tiof_put6d_r8 (obj, "rdA6", start(6:1:-1), edge(6:1:-1), &
                      real(reshape(values(1:product(edge(1:6))), edge(1:6)),kind=8), errstat)
...
subroutine check_read (filename, values, max_dims, start, edge, &
  ...
  if (int(values(1),kind=1) /= i1s) then
  ...
  if (int(values(1),kind=2) /= i2s) then
  ...
  if (int(values(1),kind=4) /= i4s) then
  ...
  if (int(values(1),kind=8) /= i8s) then
  ...
  if (real(values(1),kind=4) /= r4s) then
  ...
  if (real(values(1),kind=8) /= r8s) then
  ...
  call tiof_get1d_i1 (obj, "sbA1", start(1:1), edge(1:1), i1_1d, errstat, &
                     replace_fill=int(fillvalue,kind=1))
  if (any (int(values(1:edge(1)),kind=1) /= i1_1d)) then
  ...
  call tiof_get2d_i1 (obj, "sbA2", start(2:1:-1), edge(2:1:-1), i1_2d, errstat, &
                     replace_fill=int(fillvalue,kind=1))
  if (any (int(values(1:product(edge(1:2))),kind=1) &
  ...
  call tiof_get3d_i1 (obj, "sbA3", start(3:1:-1), edge(3:1:-1), i1_3d, errstat, &
                     replace_fill=int(fillvalue,kind=1))
  if (any (int(values(1:product(edge(1:3))),kind=1) &
  ...
  call tiof_get1d_i2 (obj, "ssA1", start(1:1), edge(1:1), i2_1d, errstat, &
                     replace_fill=int(fillvalue,kind=2))
  if (any (int(values(1:edge(1)),kind=2) /= i2_1d)) then
  ...
  call tiof_get2d_i2 (obj, "ssA2", start(2:1:-1), edge(2:1:-1), i2_2d, errstat, &
                     replace_fill=int(fillvalue,kind=2))
  if (any (int(values(1:product(edge(1:2))),kind=2) &
  ...
  call tiof_get3d_i2 (obj, "ssA3", start(3:1:-1), edge(3:1:-1), i2_3d, errstat, &
                     replace_fill=int(fillvalue,kind=2))
  if (any (int(values(1:product(edge(1:3))),kind=2) &
  ...
  call tiof_get1d_i4 (obj, "siA1", start(1:1), edge(1:1), i4_1d, errstat, &
                     replace_fill=int(fillvalue,kind=4))
  if (any (int(values(1:edge(1)),kind=4) /= i4_1d)) then
  ...
  call tiof_get2d_i4 (obj, "siA2", start(2:1:-1), edge(2:1:-1), i4_2d, errstat, &
                     replace_fill=int(fillvalue,kind=4))
  if (any (int(values(1:product(edge(1:2))),kind=4) &
  ...
  call tiof_get3d_i4 (obj, "siA3", start(3:1:-1), edge(3:1:-1), i4_3d, errstat, &
                     replace_fill=int(fillvalue,kind=4))
  if (any (int(values(1:product(edge(1:3))),kind=4) &
  ...
  call tiof_get1d_i8 (obj, "sjA1", start(1:1), edge(1:1), i8_1d, errstat, &
                     replace_fill=int(fillvalue,kind=8))
  if (any (int(values(1:edge(1)),kind=8) /= i8_1d)) then
  ...
  call tiof_get2d_i8 (obj, "sjA2", start(2:1:-1), edge(2:1:-1), i8_2d, errstat, &
                     replace_fill=int(fillvalue,kind=8))
  if (any (int(values(1:product(edge(1:2))),kind=8) &
  ...
  call tiof_get3d_i8 (obj, "sjA3", start(3:1:-1), edge(3:1:-1), i8_3d, errstat, &
                     replace_fill=int(fillvalue,kind=8))
  if (any (int(values(1:product(edge(1:3))),kind=8) &
  ...
  call tiof_get1d_r4 (obj, "rfA1", start(1:1), edge(1:1), r4_1d, errstat, &
                     replace_fill=real(fillvalue,kind=4))
  if (any (real(values(1:edge(1)),kind=4) /= r4_1d)) then
  ...
  call tiof_get2d_r4 (obj, "rfA2", start(2:1:-1), edge(2:1:-1), r4_2d, errstat, &
                     replace_fill=real(fillvalue,kind=4))
  if (any (real(values(1:product(edge(1:2))),kind=4) &
  ...
  call tiof_get3d_r4 (obj, "rfA3", start(3:1:-1), edge(3:1:-1), r4_3d, errstat, &
                     replace_fill=real(fillvalue,kind=4))
  if (any (real(values(1:product(edge(1:3))),kind=4) &
  ...
  call tiof_get4d_r4 (obj, "rfA4", start(4:1:-1), edge(4:1:-1), r4_4d, errstat, &
                     replace_fill=real(fillvalue,kind=4))
  if (any (real(values(1:product(edge(1:4))),kind=4) &
  ...
  call tiof_get5d_r4 (obj, "rfA5", start(5:1:-1), edge(5:1:-1), r4_5d, errstat, &
                     replace_fill=real(fillvalue,kind=4))
  if (any (real(values(1:product(edge(1:5))),kind=4) &
  ...
  call tiof_get6d_r4 (obj, "rfA6", start(6:1:-1), edge(6:1:-1), r4_6d, errstat, &
                     replace_fill=real(fillvalue,kind=4))
  if (any (real(values(1:product(edge(1:6))),kind=4) &
  ...
  call tiof_get1d_r8 (obj, "rdA1", start(1:1), edge(1:1), r8_1d, errstat, &
                     replace_fill=real(fillvalue,kind=8))
  if (any (real(values(1:edge(1)),kind=8) /= r8_1d)) then
  ...
  call tiof_get2d_r8 (obj, "rdA2", start(2:1:-1), edge(2:1:-1), r8_2d, errstat, &
                     replace_fill=real(fillvalue,kind=8))
  if (any (real(values(1:product(edge(1:2))),kind=8) &
  ...
  call tiof_get3d_r8 (obj, "rdA3", start(3:1:-1), edge(3:1:-1), r8_3d, errstat, &
                     replace_fill=real(fillvalue,kind=8))
  if (any (real(values(1:product(edge(1:3))),kind=8) &
  ...
  call tiof_get4d_r8 (obj, "rdA4", start(4:1:-1), edge(4:1:-1), r8_4d, errstat, &
                     replace_fill=real(fillvalue,kind=8))
  if (any (real(values(1:product(edge(1:4))),kind=8) &
  ...
  call tiof_get5d_r8 (obj, "rdA5", start(5:1:-1), edge(5:1:-1), r8_5d, errstat, &
                     replace_fill=real(fillvalue,kind=8))
  if (any (real(values(1:product(edge(1:5))),kind=8) &
  ...
  call tiof_get6d_r8 (obj, "rdA6", start(6:1:-1), edge(6:1:-1), r8_6d, errstat, &
                     replace_fill=real(fillvalue,kind=8))
  if (any (real(values(1:product(edge(1:6))),kind=8) &
