...
MODULE OMSAO_elsunc_fitting_module
  ...
  ! TPK addition
  ! ============
  USE OMSAO_precision_module, ONLY : r8, i4, i2
  IMPLICIT NONE

  ! ===================================================
  ! Dimension parameters for ELSUNC auxiliary variables
  ! ===================================================
  INTEGER (KIND=i4), PUBLIC, PARAMETER :: ELSUNC_NP = 11, ELSUNC_NW = 6
  ...
  REAL (KIND=r8), PARAMETER, PUBLIC ::   &    ! R8 versions for Valid entries
  ...
  ! -------------------------------------------------------------
  INTEGER (KIND=i4), PARAMETER, PUBLIC :: ELSUNC_LESS_IS_NOISE = 300_i4
...
CONTAINS
  ...
  SUBROUTINE soliuc(x,n,f,m,ffunc,tau,scale,mdc,bl,bu,aset,nract,c,funcev,  &
    ...
    REAL (KIND=r8)  :: work(n), w1(m), w2(m), work2(n,1), w1tmp(m)
