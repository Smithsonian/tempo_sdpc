...
!  end subroutine cspint
  ...
  subroutine cubint ( ntab, xtab, ftab, ia, ib, result, error )
    ...
    h1 = 0.0_r8; h2 = 0.0_r8; h3 = 0.0_r8
    d1 = 0.0_r8; d2 = 0.0_r8; d3 = 0.0_r8
...
!  end subroutine filon_sin
  ...
  !JCH This function shadows a fortran intrinsic and can
  !JCH only be called via an explicit interface or if declared
  !JCH EXTERNAL.  For that reason, I'm commenting out this
  !JCH function's definition.
  !JCH
  !JCH function gamma ( x )
  !JCH
  !JCH   !*****************************************************************************80
  !JCH   !
  !JCH   !! GAMMA calculates the Gamma function for a real argument X.
  !JCH   !
  !JCH   !  Definition:
  !JCH   !
  !JCH   !    GAMMA(X) = Integral ( 0 <= T <= Infinity ) T**(X-1) EXP(-T) DT
  !JCH   !
  !JCH   !  Recursion:
  !JCH   !
  !JCH   !    GAMMA(X+1) = X * GAMMA(X)
  !JCH   !
  !JCH   !  Special values:
  !JCH   !
  !JCH   !    GAMMA(0.5) = SQRT(PI)
  !JCH   !    If N is a positive integer, GAMMA(N+1) = N!, the standard factorial.
  !JCH   !
  !JCH   !  Discussion:
  !JCH   !
  !JCH   !    Computation is based on an algorithm outlined in reference 1.
  !JCH   !    The program uses rational functions that approximate the GAMMA
  !JCH   !    function to at least 20 significant decimal digits.  Coefficients
  !JCH   !    for the approximation over the interval (1,2) are unpublished.
  !JCH   !    Those for the approximation for X .GE. 12 are from reference 2.
  !JCH   !    The accuracy achieved depends on the arithmetic system, the
  !JCH   !    compiler, the intrinsic functions, and proper selection of the
  !JCH   !    machine-dependent constants.
  !JCH   !
  !JCH   !  Machine-dependent constants:
  !JCH   !
  !JCH   !    BETA: radix for the floating-point representation.
  !JCH   !    MAXEXP: the smallest positive power of BETA that overflows.
  !JCH   !    XBIG: the largest argument for which GAMMA(X) is representable
  !JCH   !      in the machine, i.e., the solution to the equation
  !JCH   !      GAMMA(XBIG) = BETA**MAXEXP.
  !JCH   !    XMININ: the smallest positive floating-point number such that
  !JCH   !      1/XMININ is machine representable.
  !JCH   !
  !JCH   !    Approximate values for some important machines are:
  !JCH   !
  !JCH   !                               BETA       MAXEXP        XBIG
  !JCH   !
  !JCH   !    CRAY-1         (S.P.)        2         8191        966.961
  !JCH   !    Cyber 180/855
  !JCH   !      under NOS    (S.P.)        2         1070        177.803
  !JCH   !    IEEE (IBM/XT,
  !JCH   !      SUN, etc.)   (S.P.)        2          128        35.040
  !JCH   !    IEEE (IBM/XT,
  !JCH   !      SUN, etc.)   (D.P.)        2         1024        171.624
  !JCH   !    IBM 3033       (D.P.)       16           63        57.574
  !JCH   !    VAX D-Format   (D.P.)        2          127        34.844
  !JCH   !    VAX G-Format   (D.P.)        2         1023        171.489
  !JCH   !
  !JCH   !                               XMININ
  !JCH   !
  !JCH   !    CRAY-1         (S.P.)   1.84D-2466
  !JCH   !    Cyber 180/855
  !JCH   !      under NOS    (S.P.)   3.14D-294
  !JCH   !    IEEE (IBM/XT,
  !JCH   !      SUN, etc.)   (S.P.)   1.18D-38
  !JCH   !    IEEE (IBM/XT,
  !JCH   !      SUN, etc.)   (D.P.)   2.23D-308
  !JCH   !    IBM 3033       (D.P.)   1.39D-76
  !JCH   !    VAX D-Format   (D.P.)   5.88D-39
  !JCH   !    VAX G-Format   (D.P.)   1.12D-308
  !JCH   !
  !JCH   !  Author:
  !JCH   !
  !JCH   !    William Cody and L. Stoltz,
  !JCH   !    Applied Mathematics Division,
  !JCH   !    Argonne National Laboratory,
  !JCH   !    Argonne, Illinois, 60439.
  !JCH   !
  !JCH   !  Reference:
  !JCH   !
  !JCH   !    William Cody,
  !JCH   !    An Overview of Software Development for Special Functions,
  !JCH   !    in Numerical Analysis Dundee, 1975,
  !JCH   !    edited by GA Watson,
  !JCH   !    Lecture Notes in Mathematics, 506,
  !JCH   !    Springer, 1976.
  !JCH   !
  !JCH   !    John Hart, Ward Cheney, Charles Lawson, Hans Maehly, Charles Mesztenyi,
  !JCH   !    John Rice, Henry Thatcher, Christoph Witzgall,
  !JCH   !    Computer Approximations,
  !JCH   !    Wiley, 1968.
  !JCH   !
  !JCH   !  Parameters:
  !JCH   !
  !JCH   !    Input, real ( KIND = r8 ) X, the argument of the function.
  !JCH   !
  !JCH   !    Output, real ( KIND = r8 ) GAMMA, the value of the function.  The program
  !JCH   !    returns the a huge value for singularities or when overflow would occur.
  !JCH   !    The computation is believed to be free of underflow and overflow.
  !JCH   !
  !JCH   USE OMSAO_precision_module, ONLY: r8
  !JCH   implicit none
  !JCH
  !JCH   real ( KIND = r8 ), parameter, dimension ( 7 ) :: c = (/ &
  !JCH     -1.910444077728E-03_r8, &
  !JCH     8.4171387781295E-04_r8, &
  !JCH     -5.952379913043012E-04_r8, &
  !JCH     7.93650793500350248E-04_r8, &
  !JCH     -2.777777777777681622553E-03_r8, &
  !JCH     8.333333333333333331554247E-02_r8, &
  !JCH     5.7083835261E-03_r8 /)
  !JCH   real ( KIND = r8 ) fact
  !JCH   real ( KIND = r8 ) gamma
  !JCH   integer i
  !JCH   integer n
  !JCH   real ( KIND = r8 ), parameter, dimension ( 8 ) :: p = (/ &
  !JCH     -1.71618513886549492533811_r8, &
  !JCH     2.47656508055759199108314E+01_r8, &
  !JCH     -3.79804256470945635097577E+02_r8, &
  !JCH     6.29331155312818442661052E+02_r8, &
  !JCH     8.66966202790413211295064E+02_r8, &
  !JCH     -3.14512729688483675254357E+04_r8, &
  !JCH     -3.61444134186911729807069E+04_r8, &
  !JCH     6.64561438202405440627855E+04_r8 /)
  !JCH   logical parity
  !JCH   real ( KIND = r8 ), parameter :: PI = &
  !JCH     3.14159265358979323846264338327950288419716939937510_r8
  !JCH   real ( KIND = r8 ), parameter, dimension ( 8 ) :: q = (/ &
  !JCH     -3.08402300119738975254353e+01_r8, &
  !JCH     3.15350626979604161529144e+02_r8, &
  !JCH     -1.01515636749021914166146e+03_r8, &
  !JCH     -3.10777167157231109440444e+03_r8, &
  !JCH     2.25381184209801510330112e+04_r8, &
  !JCH     4.75584627752788110767815e+03_r8, &
  !JCH     -1.34659959864969306392456e+05_r8, &
  !JCH     -1.15132259675553483497211e+05_r8 /)
  !JCH   real ( KIND = r8 ), parameter :: SQRTPI = 0.9189385332046727417803297_r8
  !JCH   real ( KIND = r8 ) sum1
  !JCH   real ( KIND = r8 ) x
  !JCH   real ( KIND = r8 ), parameter :: XBIG = 35.040_r8
  !JCH   real ( KIND = r8 ) xden
  !JCH   real ( KIND = r8 ), parameter :: XMININ = 1.18D-38
  !JCH   real ( KIND = r8 ) xnum
  !JCH   real ( KIND = r8 ) y
  !JCH   real ( KIND = r8 ) y1
  !JCH   real ( KIND = r8 ) ysq
  !JCH   real ( KIND = r8 ) z
  !JCH
  !JCH   parity = .false.
  !JCH   fact = 1.0_r8
  ...
  !JCH   y = x
  !JCH   !
  !JCH   !  Argument is negative.
  !JCH   !
  !JCH   if ( y <= 0.0_r8 ) then
  !JCH
  !JCH     y = - x
  !JCH     y1 = aint ( y )
  !JCH     gamma = y - y1
  !JCH
  !JCH     if ( gamma /= 0.0_r8 ) then
  !JCH
  !JCH       if ( y1 /= aint ( y1 * 0.5_r8 ) * 2.0_r8 ) then
  !JCH         parity = .true.
  !JCH       end if
  !JCH
  !JCH       fact = - PI / sin ( PI * gamma )
  !JCH       y = y + 1.0_r8
  !JCH
  !JCH     else
  !JCH
  !JCH       gamma = huge ( gamma )
  !JCH       return
  !JCH
  !JCH     end if
  !JCH
  ...
  !JCH   !  Argument < EPS
  !JCH   !
  !JCH   if ( y < epsilon ( y ) ) then
  !JCH
  !JCH     if ( XMININ <= y ) then
  !JCH       gamma = 1.0_r8 / y
  !JCH     else
  !JCH       gamma = huge ( gamma )
  !JCH       return
  !JCH     end if
  !JCH
  !JCH   else if ( y < 12.0_r8 ) then
  !JCH
  !JCH     y1 = y
  !JCH     !
  !JCH     !  0.0_r8 < argument < 1.0_r8
  !JCH     !
  !JCH     if ( y < 1.0_r8 ) then
  !JCH       z = y
  !JCH       y = y + 1.0_r8
  !JCH       !
  !JCH       !  1.0_r8 < argument < 12.0, reduce argument if necessary.
  !JCH       !
  !JCH     else
  !JCH       n = int ( y ) - 1
  !JCH       y = y - real ( n, KIND = r8 )
  !JCH       z = y - 1.0_r8
  !JCH     end if
  !JCH     !
  !JCH     !  Evaluate approximation for 1.0_r8 < argument < 2.0.
  !JCH     !
  !JCH     xnum = 0.0_r8
  !JCH     xden = 1.0_r8
  !JCH     do i = 1, 8
  ...
  !JCH     end do
  !JCH
  !JCH     gamma = xnum / xden + 1.0_r8
  !JCH     !
  !JCH     !  Adjust result for case  0.0_r8 < argument < 1.0.
  !JCH     !
  !JCH     if ( y1 < y ) then
  !JCH       gamma = gamma / y1
  !JCH       !
  !JCH       !  Adjust result for case  2.0_r8 < argument < 12.0.
  !JCH       !
  !JCH     else if ( y < y1 ) then
  !JCH
  !JCH       do i = 1, n
  !JCH         gamma = gamma * y
  !JCH         y = y + 1.0_r8
  ...
  !JCH       sum1 = c(7)
  !JCH       do i = 1, 6
  !JCH         sum1 = sum1 / ysq + c(i)
  !JCH       end do
  !JCH       sum1 = sum1 / y - y + SQRTPI
  !JCH       sum1 = sum1 + ( y - 0.5_r8 ) * log ( y )
  !JCH       gamma = exp ( sum1 )
  !JCH
  !JCH     else
  !JCH
  ...
  !JCH   end if
  !JCH   !
  !JCH   !  Final adjustments and return.
  !JCH   !
  !JCH   if ( parity ) then
  !JCH     gamma = - gamma
  !JCH   end if
  !JCH
  !JCH   if ( fact /= 1.0_r8 ) then
  !JCH     gamma = fact / gamma
  !JCH   end if
  !JCH
  !JCH   return
