MODULE OMSAO_indices_module
  ...
  !     sgk  super-Gaussian shape factor
  !     shi: spectral shift
  ...
  INTEGER (KIND=i4), PARAMETER :: &
    ...
    sin_idx = 13, hwe_idx = 14, asy_idx = 15, sgk_idx = 16, shi_idx = 17, squ_idx = 18,               &
  ...
  INTEGER (KIND=i4), PARAMETER :: VOC_AMF_IDX = 1, VOC_ISCCP_IDX = 2, &
    VOC_OMICLD_IDX = 3
  ...
  ! --------------------------------
  INTEGER (KIND=i4), PARAMETER :: OMSAO_OMLER_lun = 700280
