...
!unused   END FUNCTION L1Bga_EarthSunDistance
  ...
  SUBROUTINE omi_read_radiance_lines ( &
    ...
    call tiof_get2d_r4 (tio_l1obj, tg_var_latitude, [iline,0], [nloop,-1], omi_latitude(1:nxtrack,0:nloop-1), errstat)
    call tiof_get2d_r4 (tio_l1obj, tg_var_longitude, [iline,0], [nloop,-1], omi_longitude(1:nxtrack,0:nloop-1), errstat)
    call tiof_get2d_r4 (tio_l1obj, tg_var_sz_angle, [iline,0], [nloop,-1], omi_szenith(1:nxtrack,0:nloop-1), errstat)
    call tiof_get2d_r4 (tio_l1obj, tg_var_sa_angle, [iline,0], [nloop,-1], omi_sazimuth(1:nxtrack,0:nloop-1), errstat)
    call tiof_get2d_r4 (tio_l1obj, tg_var_vz_angle, [iline,0], [nloop,-1], omi_vzenith(1:nxtrack,0:nloop-1), errstat)
    call tiof_get2d_r4 (tio_l1obj, tg_var_va_angle, [iline,0], [nloop,-1], omi_vazimuth(1:nxtrack,0:nloop-1), errstat)
    call tiof_get2d_i2 (tio_l1obj, "ellipsoid_altitude", [iline,0], [nloop,-1], omi_height(1:nxtrack,0:nloop-1), errstat)
    call tiof_get2d_i2 (tio_l1obj, "GroundPixelQualityFlags", [iline,0], [nloop,-1], omi_geoflg(1:nxtrack,0:nloop-1), errstat)
    call tiof_get2d_i1 (tio_l1obj, "XTrackQualityFlags", [iline,0], [nloop,-1], omi_xtrflg_l1b(1:nxtrack,0:nloop-1), errstat)
    call tiof_get3d_r4 (tio_l1obj, tg_var_radiance, [iline,0,0], [nloop,-1,-1], tmp_spc(:,1:nxtrack,0:nloop-1), errstat)
    call tiof_get3d_i2 (tio_l1obj, tg_var_dqf, [iline,0,0], [nloop,-1,-1], tmp_flg(:,1:nxtrack,0:nloop-1), errstat)
    call tiof_get3d_r4 (tio_l1obj, tg_var_wavelength, [iline,0,0], [nloop,-1,-1], tmp_wvl(:,1:nxtrack,0:nloop-1), errstat)
    call tiof_close (tio_l1obj, errstat)
    if (errstat < 0) return
  ...
  SUBROUTINE omi_read_glint_ice_flags ( l1bfile, nx, nt, snow_ice_flg, glint_flg, errstat )
    ...
    call tiof_open (l1bfile, tio_l1obj, nf90_nowrite, errstat)
    call tiof_inq_group (tio_l1obj, omi_radiance_swathname, errstat)
    call tiof_get2d_i2 (tio_l1obj, "GroundPixelQualityFlags", [0,0], [nt,-1], geoflg(1:nx,0:nt-1), errstat)
    call tiof_close (tio_l1obj, errstat)
    if (errstat < 0) return
