...
CONTAINS
  ...
  SUBROUTINE omi_read_radiance_lines ( &
    ...
    call tiof_get2d_r4 (tio_l1obj, tempo_var_longitude, iline, nloop, omi_longitude, errstat)
    call tiof_get2d_r4 (tio_l1obj, tempo_var_sz_angle, iline, nloop, omi_szenith, errstat)
    call tiof_get2d_r4 (tio_l1obj, tempo_var_sa_angle, iline, nloop, omi_sazimuth, errstat)
    call tiof_get2d_r4 (tio_l1obj, tempo_var_vz_angle, iline, nloop, omi_vzenith, errstat)
    call tiof_get2d_r4 (tio_l1obj, tempo_var_va_angle, iline, nloop, omi_vazimuth, errstat)
    ...
    call tiof_get3d_r4 (tio_l1obj, tempo_var_radiance, iline, nloop, tmp_spc, errstat)
    call tiof_get3d_i2 (tio_l1obj, tempo_var_dqf, iline, nloop, tmp_flg, errstat)
    call tiof_get3d_r4 (tio_l1obj, tempo_var_wavelength, iline, nloop, tmp_wvl, errstat)
    call tiof_close (tio_l1obj, errstat)
    if (errstat < 0) return
