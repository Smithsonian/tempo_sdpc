MODULE gauss
CONTAINS
SUBROUTINE convolve_asym_gauss ( npoints, hw1e, e_asym, wvlarr, specarr, specmod)
  ...
  RETURN
END SUBROUTINE convolve_asym_gauss

SUBROUTINE convolve_gauss (wvlarr, specarr, specmod, npoints, hw1e)
