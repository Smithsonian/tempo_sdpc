...
extern int Pixel_grid_arrays (const Pixel_Grid_Param_Type *g,
                              double **x_corners, double **y_corners);

extern Pixel_Regrid_Type *
Pixel_open_regrid (const Pixel_List_Type *src_lookup, const Pixel_Grid_Param_Type *dest,
                   const Pixel_List_Type *src_area, const Pixel_List_Type *dest_area);

extern void Pixel_close_regrid (Pixel_Regrid_Type *r);
extern int Pixel_regrid (const Pixel_Regrid_Type *r, double *src, int *src_mask,
